        ...
        <>
            {createPortal(
                <div ref={modalRef} data-testid="modal" className="flex justify-center w-full h-full">
                    <div className="flex flex-col bg-white px-4 py-4 rounded-md border border-neutral-200 drop-shadow-2xl w-5/6 min-h-80 max-h-[600px] absolute animate-enter-from-bottom">
