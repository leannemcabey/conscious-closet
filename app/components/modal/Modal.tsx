                ...
                <div data-testid="translucent-layer" className="absolute top-0 left-0 h-screen w-screen bg-transparent-bg">
                    <div className="flex justify-center w-full h-full">
                        <div
                            ref={modalRef}
                            data-testid="modal"
                            className="flex flex-col bg-white px-4 py-4 rounded-md border border-neutral-200 drop-shadow-2xl w-5/6 max-w-80 min-h-80 absolute animate-enter-from-bottom md:max-w-[500px]"
                        >
