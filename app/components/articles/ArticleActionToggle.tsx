...
const ArticleActionToggle = ({ iconFile, iconAlt, isActive, clickHandler }: ArticleActionToggleProps) => {
    if (isActive) {
        return (
            <div
                className={`justify-end bg-theme-light-green flex max-w-[70px] rounded-lg mx-1 drop-shadow md:max-w-[100px]`}>
                <div className="w-[60%]">
    ...
    if (!isActive) {
        return (
            <div className={`bg-white flex max-w-[70px] rounded-lg mx-1 drop-shadow md:max-w-[100px]`}>
                <div className="w-[60%]">
