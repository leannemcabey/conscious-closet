...
const CleanoutBagFilter = ({ showCleanoutBagItems, setShowCleanoutBagItems }: CleanoutBagFilterProps) => {
    ...
    return (
        <button
            ...
            className={`${styling(showCleanoutBagItems)} px-2 mr-1 h-8 rounded-full text-xs border border-theme-blue text-theme-blue truncate md:text-xl md:px-4 md:h-10`}
        >
