...
const LaundrySymbolsContainer = () => {
    const headerStyling = "w-full sticky top-0 text-xl text-theme-blue bg-white rounded-md p-2";
    const symbolContainerStyling = "w-full grid grid-cols-3 gap-x-4 gap-y-4";

    return (
        <div className="h-5/6 w-full overflow-scroll mt-8 flex flex-col items-center text-center space-y-4">
            <div>
