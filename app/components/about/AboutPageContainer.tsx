...
const AboutPageContainer = () => {
    return (
        <div className="flex flex-col place-content-between h-full overflow-scroll pb-4">
            ...
            <div>
                <h3 className="mt-8 pt-8 mb-4 text-center border border-dotted border-theme-green border-t-2 border-b-0 border-r-0 border-l-0 tracking-widest text-lg lg:mb-8 text-text-green">
                    meet the founder
                </h3>
                <div className="mb-12 lg:w-[70%] lg:self-center">
