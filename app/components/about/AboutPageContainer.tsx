        ...
        <div className="h-full mb-8">
            ...
            <div className="h-3/4 overflow-scroll">
                <AboutSection sectionName="Know what you have & what you don't wear">
                    <p>
                        How many times have you rediscovered an item of clothing that you completely forget you had?
                    ...
                    <p>
                        ...
                        trouble choosing, we think we need to buy more. So we need to simplify things by ridding our
                ...
                <AboutSection sectionName="Buy less">
                    ...
                    have so many? It goes back to what we said before about decision fatigue when looking at our
                ...
                <AboutSection sectionName="Don't throw out what you don't wear">
                    ...
                    We recommend donating, thrifting, or recycling your unwanted clothes. Check out our
                    <Link href="/cleanout/recommendations" className="text-theme-green"> cleanout recs</Link> page for
                    some suggestions on where to do this!
                </AboutSection>
            </div>
        </div>
    )
