...
const ArticleFilters = ({ filterTypes }: ArticleFiltersProps) => {
    ...
    return (
        <div className="mb-4 px-1 py-2 flex place-content-between items-center bg-background-green border border-theme-green border-dotted rounded-lg drop-shadow">
