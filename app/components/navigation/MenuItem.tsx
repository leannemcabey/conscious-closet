...
const MenuItem = ({ linkTo, imageSrc, imageAltText, label, subItems }: MenuItemProps) => {
    ...
    return (
        <div className="text-lg flex flex-col py-4 md:py-6 border border-dotted border-neutral-300 border-b-2 border-t-0 border-l-0 border-r-0">
            <div className="flex space-x-4">
                {subItems &&
                    <div className="w-[12px] h-[12px] mt-1 md:w-[20px] md:h-[20px]">
                        <Image
                            src={`/${arrow}.svg`}
                            width="12"
                            height="12"
                ...
                <Link href={linkTo}>
                    <div className={`flex space-x-4 ${!subItems ? "ml-6 md:ml-9": ""}`}>
            ...
            {subItems && isOpen &&
                <div className="mt-4 ml-16 md:ml-20 pl-2 flex flex-col space-y-2.5 border border-neutral-300 border-b-0 border-t-0 border-l-1 border-r-0">
